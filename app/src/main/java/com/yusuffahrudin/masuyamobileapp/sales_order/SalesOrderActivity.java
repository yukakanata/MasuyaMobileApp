...
public class SalesOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("List Sales Order");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SalesOrderActivity.this, CreateSalesOrder.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0 :
                    return new AllSOFragment();
                case 1:
                    return new OpenSOFragment();
                case 2:
                    return new PendingSOFragment();
                case 3:
                    return new ClosedSOFragment();
            }
