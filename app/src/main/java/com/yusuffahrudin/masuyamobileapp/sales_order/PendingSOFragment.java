...
public class PendingSOFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_so_pending, container, false);
    ...
    private class AdapterRVSO extends RecyclerView.Adapter <PendingSOFragment.AdapterRVSO.ViewHolder> {
    ...
    private void selectSO(){
        ...
        url_select = a.URL() + "salesorder/select_sales_order_pending.php";
