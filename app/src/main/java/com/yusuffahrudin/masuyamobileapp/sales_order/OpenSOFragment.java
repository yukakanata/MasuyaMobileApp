...
public class OpenSOFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_so_open, container, false);
    ...
    private class AdapterRVSO extends RecyclerView.Adapter <OpenSOFragment.AdapterRVSO.ViewHolder> {
    ...
    private void selectSO(){
        ...
        url_select = a.URL() + "salesorder/select_sales_order_open.php";
