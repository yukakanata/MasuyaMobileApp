...
public class ClosedSOFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_so_closed, container, false);
    ...
    private class AdapterRVSO extends RecyclerView.Adapter <ClosedSOFragment.AdapterRVSO.ViewHolder> {
    ...
    private void selectSO(){
        ...
        url_select = a.URL() + "salesorder/select_sales_order_closed.php";
